...
def train_models(X, y):
    ...
    models = {
        ...
        'NeuralNet': MLPClassifier(hidden_layer_sizes=(128, 64), max_iter=2000, early_stopping=True, random_state=42)
    }
    results = {}
